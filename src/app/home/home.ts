...
export class Home {
  ...
  private wyszukiwarka = inject(Wyszukiwarka);
...
// toLocaleLowerCase() i toLowerCase() zamienia wszystkie litery na male
  ...
  constructor() {
    ...
    // automatyczne reagowanie na zmiany w sygnalach (np w this.wyszukiwarka.ts) ogarnia funkcja effect
    effect (() => { this.filtruj(this.wyszukiwarka.szukanaFraza())});
